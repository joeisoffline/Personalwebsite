// Well done here as well, everyone.
// Your microwave looks and functions great!  While you didn't have the
// Cancel button named 'exactly' as required in the GUI, the proper functionality
// was there. Otherwise everything was great and you've nicely commented things in here
// 9/10
...
function CountDown()
{
    if (mCounter >=0)
    {
        ...
        if (sCounter == 0)
        {
            if (mCounter == 0)
            {
                //If the timer count is zero, add logic to do the peeping
                doFlash = true;
                stopTimer();
                microwaveAnimation();
